    ...
    <div className="min-h-screen bg-white text-gray-800 font-sans relative">
      ...
      <section className="bg-[#0b53c1] pt-20 pb-28 px-4 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <h1 className="text-3xl md:text-5xl font-bold text-white mb-6 uppercase tracking-wide">
            Khách hàng của chúng tôi
          </h1>
          <p className="text-blue-100 mb-10 text-lg md:text-xl">
            Hơn 2.500 phòng khám và bệnh viện trên toàn quốc đang tin tưởng <br className="hidden md:block" /> 
            sử dụng hệ thống phần mềm của Webnhathuoc.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link href="#contact" className="bg-white/10 hover:bg-white/20 border border-white/30 text-white px-8 py-3.5 rounded-full font-bold transition w-full sm:w-auto">
              Liên hệ tư vấn
            </Link>
          </div>
        </div>
      ...
      {/* ==========================================
          3. LOGO KHÁCH HÀNG (Grid)
      ========================================== */}
      <section className="py-12 bg-white max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <p className="text-center text-sm font-semibold text-gray-400 uppercase tracking-widest mb-8">Các đơn vị tiêu biểu đồng hành cùng chúng tôi</p>
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6 items-center justify-center opacity-70 grayscale hover:grayscale-0 transition-all duration-500">
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div key={i} className="flex items-center justify-center p-4 border border-gray-100 rounded-xl bg-gray-50 hover:bg-white hover:shadow-md transition cursor-pointer">
              <div className="flex items-center gap-2 text-gray-500 font-bold">
                <Building2 size={24} className="text-[#0b53c1]" />
                <span>Phòng khám {i}</span>
              </div>
            </div>
          ))}
        </div>
      ...
      {/* ==========================================
          4. KHÁCH HÀNG TIÊU BIỂU (Cards)
      ========================================== */}
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#1e3a8a] mb-4">Khách hàng tiêu biểu</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">Những đơn vị y tế hàng đầu đã ứng dụng thành công giải pháp quản lý của chúng tôi vào quy trình vận hành thực tế.</p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {[
              { name: 'Bệnh viện Đa khoa Tâm Anh', type: 'Bệnh viện Đa khoa', desc: 'Quy mô 500+ giường bệnh, sử dụng toàn diện giải pháp quản lý hồ sơ nội trú và ngoại trú.' },
              { name: 'Hệ thống Nha khoa Nụ Cười', type: 'Chuỗi phòng khám', desc: 'Quản lý đồng bộ dữ liệu cho 15 chi nhánh trên toàn quốc với hơn 2000 lượt khách mỗi ngày.' },
              { name: 'Phòng khám Nhi đồng Quốc tế', type: 'Phòng khám chuyên khoa', desc: 'Ứng dụng module Chat AI tư vấn triệu chứng và hệ thống đặt lịch tự động hóa 100%.' },
            ].map((client, idx) => (
              <div key={idx} className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-200 hover:shadow-lg transition group">
                <div className="h-48 bg-[#0b53c1]/10 flex items-center justify-center overflow-hidden relative">
                  <Building className="w-16 h-16 text-[#0b53c1]/40 group-hover:scale-110 transition duration-500" />
                  <div className="absolute top-4 left-4 bg-white/80 backdrop-blur-sm px-3 py-1 rounded-md text-xs font-bold text-[#0b53c1]">
                    {client.type}
                  </div>
                </div>
                <div className="p-6">
      ...
      {/* ==========================================
          5. CASE STUDY (Thành công thực tế)
      ========================================== */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-orange-100 text-orange-600 font-semibold text-sm mb-6">
              <Star size={16} fill="currentColor" /> Case Study Nổi Bật
            </div>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 leading-tight">
              Hành trình số hóa của <span className="text-[#0b53c1]">Phòng Khám Đa Khoa Sài Gòn</span>
            </h2>
            <p className="text-gray-600 mb-6 text-lg leading-relaxed">
              Trước khi sử dụng Webphongkham, phòng khám gặp rất nhiều khó khăn trong việc lưu trữ hồ sơ giấy và xếp hàng chờ đợi. Chỉ sau 2 tháng triển khai hệ thống:
            </p>
            <ul className="space-y-4 mb-8">
              <li className="flex items-start gap-3">
                <CheckCircle2 className="text-green-500 mt-1 shrink-0" />
                <span className="text-gray-700">Giảm <strong>60%</strong> thời gian chờ đợi của bệnh nhân tại quầy tiếp đón.</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="text-green-500 mt-1 shrink-0" />
                <span className="text-gray-700">Tiết kiệm <strong>100%</strong> chi phí in ấn sổ khám bệnh bằng bệnh án điện tử.</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="text-green-500 mt-1 shrink-0" />
                <span className="text-gray-700">Tăng <strong>30%</strong> doanh thu nhờ hệ thống nhắc lịch tái khám tự động qua SMS.</span>
              </li>
            </ul>
            <Link href="#" className="inline-flex items-center gap-2 text-[#0b53c1] font-bold hover:gap-3 transition-all">
              Đọc chi tiết câu chuyện <ArrowRight size={18} />
            </Link>
          </div>
          
          <div className="relative">
            <div className="rounded-3xl overflow-hidden shadow-2xl relative group cursor-pointer">
              <div className="absolute inset-0 bg-black/40 group-hover:bg-black/20 transition duration-300 z-10 flex items-center justify-center">
                <PlayCircle className="w-16 h-16 text-white opacity-80 group-hover:scale-110 group-hover:opacity-100 transition" />
              </div>
              <img 
            ...
            {/* Decoration block */}
            <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-[url('https://www.transparenttextures.com/patterns/dot-noise.png')] opacity-20 -z-10 rounded-2xl bg-[#0b53c1]"></div>
          </div>
        </div>
      </section>

      {/* ==========================================
          6. SỐ LIỆU THỐNG KÊ (Counter)
      ========================================== */}
      <section className="py-16 bg-gradient-to-r from-[#0b53c1] to-[#1e3a8a] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center divide-x divide-white/20">
            <div className="p-4">
              <div className="flex justify-center mb-4"><Building2 size={36} className="text-yellow-400" /></div>
              <div className="text-4xl md:text-5xl font-bold mb-2">2,500+</div>
              <div className="text-blue-100 font-medium">Phòng khám & Bệnh viện</div>
            </div>
            <div className="p-4">
              <div className="flex justify-center mb-4"><Users size={36} className="text-yellow-400" /></div>
              <div className="text-4xl md:text-5xl font-bold mb-2">5M+</div>
              <div className="text-blue-100 font-medium">Hồ sơ bệnh nhân</div>
            </div>
            <div className="p-4">
              <div className="flex justify-center mb-4"><CalendarDays size={36} className="text-yellow-400" /></div>
              <div className="text-4xl md:text-5xl font-bold mb-2">10+</div>
              <div className="text-blue-100 font-medium">Năm kinh nghiệm</div>
            </div>
            <div className="p-4 border-none md:border-solid">
              <div className="flex justify-center mb-4"><TrendingUp size={36} className="text-yellow-400" /></div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                text: "Phần mềm rất dễ sử dụng, ngay cả với các bác sĩ lớn tuổi. Đội ngũ hỗ trợ kỹ thuật cực kỳ nhiệt tình, luôn sẵn sàng giải quyết vấn đề 24/7.",
                author: "BS. Trần Thanh Bình",
                role: "Giám đốc Phòng khám Bình Minh"
              },
              {
                text: "Từ khi áp dụng phần mềm, công tác quản lý kho thuốc và kê đơn trở nên chính xác tuyệt đối. Hệ thống báo cáo doanh thu rất trực quan và chi tiết.",
                author: "Dược sĩ Lê Mai",
                role: "Quản lý Chuỗi nhà thuốc Tâm An"
              },
              {
                text: "Tính năng đặt lịch online và chat AI gợi ý triệu chứng thực sự là một điểm cộng lớn, giúp bệnh nhân của chúng tôi có trải nghiệm tốt hơn hẳn.",
                author: "ThS. BS Nguyễn Hoàng",
                role: "Trưởng khoa Khám Bệnh - BV Sài Gòn"
              }
            ].map((review, idx) => (
              <div key={idx} className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 relative mt-4">
                <div className="absolute -top-5 left-8 w-10 h-10 bg-[#0b53c1] rounded-full flex items-center justify-center text-white shadow-md">
                  <Quote size={20} />
                </div>
      ...
      {/* ==========================================
          8. ĐỐI TÁC (Partners)
      ========================================== */}
      <section className="py-12 bg-white max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-t border-gray-100">
        <p className="text-center text-sm font-semibold text-gray-400 uppercase tracking-widest mb-8">Đối tác công nghệ & y tế</p>
      ...
      <section className="py-16 px-4">
        <div className="max-w-5xl mx-auto bg-gradient-to-br from-[#0b53c1] to-[#172554] rounded-3xl p-10 md:p-16 text-center text-white shadow-2xl relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-white/5 rounded-full blur-3xl translate-x-1/2 -translate-y-1/2"></div>
          
          <h2 className="text-3xl md:text-4xl font-bold mb-4 relative z-10">Sẵn sàng để tối ưu hóa phòng khám của bạn?</h2>
          <p className="text-blue-100 mb-8 text-lg max-w-2xl mx-auto relative z-10">
            Tham gia cùng hàng ngàn khách hàng khác đang sử dụng Webphongkham để nâng cao chất lượng dịch vụ y tế.
          </p>
