  ...
  return (
    <div className="space-y-6 pb-10 animate-fade-in">
      ...
      <div className="flex flex-col gap-1 mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Lịch hẹn hôm nay</h1>
        <p className="text-sm text-gray-500">Quản lý và Check-in cho các bệnh nhân có lịch khám trong ngày hôm nay</p>
      </div>
        ...
        <div className="overflow-x-auto min-h-[400px]">
          {appointments.length === 0 && !isLoading ? (
             <div className="p-20 text-center flex flex-col items-center justify-center">
               ...
               <p className="text-gray-500 text-sm">Chưa có bệnh nhân nào đặt lịch khám cho hôm nay.</p>
             </div>
          ) : (
