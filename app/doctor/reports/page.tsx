    ...
    <div className="min-h-screen flex bg-gray-50 font-sans text-gray-800 overflow-hidden">
      ...
      <aside className="w-64 bg-[#172554] text-gray-300 flex flex-col h-screen sticky top-0 shrink-0">
        ...
        <div className="flex-1 overflow-y-auto py-6 flex flex-col gap-1 px-3">
          ...
          {/* Menu Active */}
          <Link href="/doctor/reports" className="flex items-center gap-3 px-4 py-3 bg-[#2563EB] text-white rounded-xl font-medium shadow-md transition">
        ...
        <div className="p-4 border-t border-blue-900/50 space-y-1">
          ...
          {/* Nút Đăng xuất có gắn sự kiện onClick */}
          <button 
      ...
      <main className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-8 bg-gray-50/50">
          ...
          <div className="grid grid-cols-3 xl:grid-cols-6 gap-6 mb-8">
            ...
            <div className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 relative overflow-hidden group hover:shadow-md transition">
              <div className="absolute right-0 top-0 opacity-10 group-hover:scale-110 transition-transform"><TestTube size={80} className="text-orange-500"/></div>
              <p className="text-sm text-gray-500 font-medium mb-1">Xét nghiệm</p>
              <p className="text-3xl font-black text-gray-900">1,520</p>
              <p className="text-xs text-red-500 font-bold mt-2 flex items-center gap-1"><ArrowUpRight size={14} className="rotate-90"/> -1.5% so với kỳ trước</p>
            </div>
            <div className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 relative overflow-hidden group hover:shadow-md transition">
