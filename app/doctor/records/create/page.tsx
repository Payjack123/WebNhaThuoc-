  ...
  useEffect(() => {
    const fetchInit = async () => {
      ...
      if (res.success && res.data) {
        ...
        if (res.data.appointment?.reason) setReason(res.data.appointment.reason);
        if (res.data.patient?.medicalHistory) setMedicalHistory(res.data.patient.medicalHistory);
      }
      setIsLoading(false);
    };
    fetchInit();
          ...
          <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-5">
                ...
                <div className="space-y-4 text-[13px] border-t border-gray-100 pt-5 mb-6">
                  <div className="flex"><span className="w-28 text-gray-500">Ngày sinh</span><span className="font-medium text-gray-900">{initData.patient.dob} ({initData.patient.age} tuổi)</span></div>
                  <div className="flex"><span className="w-28 text-gray-500">Số điện thoại</span><span className="font-medium text-gray-900">{initData.patient.phone}</span></div>
                  <div className="flex items-start"><span className="w-28 text-gray-500 mt-0.5">Địa chỉ</span><span className="font-medium text-gray-900 flex-1 leading-relaxed">{initData.patient.address}</span></div>
                  <div className="flex"><span className="w-28 text-gray-500">Nhóm máu</span><span className="font-medium text-gray-900">{initData.patient.bloodType}</span></div>
                  <div className="flex"><span className="w-28 text-gray-500">Dị ứng</span><span className="font-medium text-gray-900">{initData.patient.allergies}</span></div>
                  <div className="flex"><span className="w-28 text-gray-500">Bảo hiểm y tế</span><span className="font-medium text-gray-900">{initData.patient.insurance}</span></div>
                </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-5">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="relative">
                    ...
                    <textarea rows={4} className="w-full px-3 py-2.5 bg-white border border-gray-200 rounded-lg text-[13px] focus:border-[#2563EB] outline-none resize-none leading-relaxed text-gray-800" value={symptoms} onChange={e => setSymptoms(e.target.value)}></textarea>
                    <span className="absolute bottom-2 right-2 text-[10px] text-gray-400">128/1000</span>
                  </div>
                  <div className="relative">
                    <label className="block text-[11px] font-bold text-gray-600 mb-1.5">Tiền sử bệnh</label>
                    <textarea rows={4} className="w-full px-3 py-2.5 bg-white border border-gray-200 rounded-lg text-[13px] focus:border-[#2563EB] outline-none resize-none leading-relaxed text-gray-800" value={medicalHistory} onChange={e => setMedicalHistory(e.target.value)}></textarea>
                    <span className="absolute bottom-2 right-2 text-[10px] text-gray-400">76/1000</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-5 relative">
                ...
                <textarea rows={5} className="w-full px-3 py-2.5 bg-white border border-gray-200 rounded-lg text-[13px] focus:border-[#2563EB] outline-none resize-none leading-relaxed text-gray-800" defaultValue="- Tỉnh táo, tiếp xúc tốt.&#10;- Không phù, không xuất huyết dưới da.&#10;- Tim đều, phổi nghe trong, không ran.&#10;- Bụng mềm, không đau.&#10;- Thần kinh: Không dấu hiệu khu trú."></textarea>
                <span className="absolute bottom-7 right-7 text-[10px] text-gray-400">123/2000</span>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-5">
                ...
                <div className="space-y-5">
                  ...
                  <div>
                    ...
                    <div className="relative flex items-center">
                      <Search className="absolute left-3 text-gray-400" size={14} />
                      <input type="text" placeholder="Nhập chẩn đoán phụ (không bắt buộc)" className="w-full pl-8 pr-16 py-2 bg-white border border-gray-200 rounded-lg text-[13px] font-medium focus:border-[#2563EB] outline-none" />
                      <div className="absolute right-2 px-1.5 py-0.5 border border-gray-200 rounded text-[10px] font-bold text-gray-600 flex items-center gap-0.5">
                  ...
                  <div className="relative pt-2">
                    ...
                    <textarea rows={4} className="w-full px-3 py-2.5 bg-white border border-gray-200 rounded-lg text-[13px] focus:border-[#2563EB] outline-none resize-none leading-relaxed text-gray-800" placeholder="Nhập kết luận"></textarea>
                    <span className="absolute bottom-2 right-2 text-[10px] text-gray-400">112/1000</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-5 relative">
                ...
                <textarea rows={5} className="w-full px-3 py-2.5 bg-white border border-gray-200 rounded-lg text-[13px] focus:border-[#2563EB] outline-none resize-none leading-relaxed text-gray-800" value={treatment} onChange={e => setTreatment(e.target.value)} placeholder="Hướng điều trị"></textarea>
                <span className="absolute bottom-7 right-7 text-[10px] text-gray-400">98/1000</span>
              </div>
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-5">
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                  <div>
                    ...
                    <input type="date" defaultValue="2026-09-01" className="w-full px-3 py-2 bg-white border border-gray-200 rounded-lg text-[13px] focus:border-[#2563EB] outline-none" />
                  </div>
                  <div>
                    <label className="block text-[11px] font-bold text-gray-600 mb-1.5">Giờ</label>
                    <input type="time" defaultValue="08:00" className="w-full px-3 py-2 bg-white border border-gray-200 rounded-lg text-[13px] focus:border-[#2563EB] outline-none" />
                  </div>
                </div>
                <div>
                  <label className="block text-[11px] font-bold text-gray-600 mb-1.5">Lý do tái khám</label>
                  <input type="text" placeholder="Lý do tái khám" className="w-full px-3 py-2 bg-white border border-gray-200 rounded-lg text-[13px] focus:border-[#2563EB] outline-none text-gray-800" />
                </div>
              </div>
